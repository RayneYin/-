# HGDoll Web Plugin - 网页端游戏 AI 陪玩插件

HGDoll 网页端 Chrome 浏览器扩展插件。在你玩**电脑网页端游戏**时，AI 可实时看到你的游戏画面，陪你聊天、为你加油鼓劲！
...
1. 打开你要玩的网页游戏
2. 点击 HGDoll 插件图标 → **启动陪玩**
3. 页面右下角出现 HGDoll 悬浮面板
4. 插件会自动定时截图分析游戏画面
5. 点击麦克风按钮可以语音对话
