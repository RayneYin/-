...
- Doubao-1.5-pro-32k：主要参与记忆信息的处理，在当前画面无法直接回答用户问题时，大语言模型将结合历史记忆提供精准答案。
- Doubao-1.5-vision-pro-32k：负责对摄像头实时捕捉的视频画面进行视觉内容理解。
...
- 已创建 Doubao-1.5-Vision-Pro 32K 的 endpoint  [参考文档](https://www.volcengine.com/docs/82379/1099522#594199f1)
